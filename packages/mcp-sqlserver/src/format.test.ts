...
import type { SqlserverExecutionResult } from './types.js';

describe('formatResult', () => {
  const sampleResult: SqlserverExecutionResult = {
    rows: [
  ...
  it('uses binary search to quickly truncate results exceeding maxResultBytes', () => {
    ...
    const largeResult: SqlserverExecutionResult = {
      rows: manyRows,
  ...
  it('handles bigint and buffer values correctly', () => {
    const specialResult: SqlserverExecutionResult = {
